...
HD_PWD='/home/wayne/FPGA_stuff/FinancialAccleration/TestEnvironments/urbana_test_project/urbana_orderbook_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bruh_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bruh_top.tcl
