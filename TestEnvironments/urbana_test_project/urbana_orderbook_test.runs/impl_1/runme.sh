...
HD_PWD='/home/wayne/FPGA_stuff/FinancialAccleration/TestEnvironments/urbana_test_project/urbana_orderbook_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bruh_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bruh_top.tcl -notrace
