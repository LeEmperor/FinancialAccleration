...
HD_PWD='/home/wayne/FPGA_stuff/FinancialAccleration/TestEnvironments/orderbook_test1/vivado_proj/implementation_folder/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log orderbook.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source orderbook.tcl -notrace
