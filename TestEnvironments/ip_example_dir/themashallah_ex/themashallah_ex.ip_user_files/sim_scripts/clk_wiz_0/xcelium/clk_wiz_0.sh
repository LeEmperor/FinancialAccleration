...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
