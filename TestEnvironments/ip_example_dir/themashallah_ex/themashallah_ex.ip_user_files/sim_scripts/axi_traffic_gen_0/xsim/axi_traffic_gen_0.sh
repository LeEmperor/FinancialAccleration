...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L axi_traffic_gen_v3_0_21 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_traffic_gen_0 xil_defaultlib.axi_traffic_gen_0 xil_defaultlib.glbl -log elaborate.log
}
