...
design_libs_elab="-libname xpm -libname dist_mem_gen_v8_0_17 -libname axi_traffic_gen_v3_0_21 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm dist_mem_gen_v8_0_17 axi_traffic_gen_v3_0_21 xil_defaultlib)
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
  ...
  xmvlog -work dist_mem_gen_v8_0_17 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
  "../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_traffic_gen_v3_0_21 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
  "../../../ipstatic/hdl/axi_traffic_gen_v3_0_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
