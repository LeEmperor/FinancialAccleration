...
design_libs=(xpm dist_mem_gen_v8_0_17 axi_traffic_gen_v3_0_21 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
  ...
  vlogan -work dist_mem_gen_v8_0_17 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
  "../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_traffic_gen_v3_0_21 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
  "../../../ipstatic/hdl/axi_traffic_gen_v3_0_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/src/verilog" +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
