...
#
# Script generated by Vivado on Sun Oct 19 18:52:18 EDT 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : themashallah.sh
...
#
# Usage        : themashallah.sh
#                themashallah.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                themashallah.sh [-reset_run]
#                themashallah.sh [-reset_log]
#                themashallah.sh [-help]
#
...
#                script (type 'themashallah.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_lite_ipif_v3_0_4 -libname axi_uartlite_v2_0_39 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_lite_ipif_v3_0_4 axi_uartlite_v2_0_39 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "themashallah.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./themashallah.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.themashallah xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.themashallah -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log themashallah_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./themashallah.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: themashallah.sh [-help]\n\
Usage: themashallah.sh [-step]\n\
Usage: themashallah.sh [-lib_map_path]\n\
Usage: themashallah.sh [-reset_run]\n\
Usage: themashallah.sh [-reset_log]\n\
Usage: themashallah.sh [-keep_index]\n\
Usage: themashallah.sh [-noclean_files]\n\n\
