...
design_libs=(xpm axi_lite_ipif_v3_0_4 axi_uartlite_v2_0_39 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../xilinx/vivado_install/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.themashallah xil_defaultlib.glbl -o themashallah_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./themashallah_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key themashallah_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc themashallah_simv.daidir vcs_lib c.obj)
