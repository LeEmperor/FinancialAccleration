...
entity themashallah_exdes_tb is

end entity;

architecture tb of themashallah_exdes_tb is

component themashallah_exdes 
   port (
...
constant freq_per : time := 10.0 ns;
--constant RATIO             : integer := 100000000 / (16 * 115200); 
 function CALC_RATIO ( C_S_AXI_ACLK_FREQ_HZ : integer;
    ...
    constant RATIO : integer := CALC_RATIO(100000000 ,115200);
...
signal tx_reg : std_logic_vector(8 -1 downto 0) := dft_val(8 -1 downto 0);
