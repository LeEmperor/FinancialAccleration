...
HD_PWD='/home/wayne/FPGA_stuff/FinancialAccleration/TestEnvironments/ip_example_dir/themashallah_ex/themashallah_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log themashallah_exdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source themashallah_exdes.tcl -notrace
