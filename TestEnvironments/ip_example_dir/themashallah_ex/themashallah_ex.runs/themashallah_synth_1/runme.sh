...
HD_PWD='/home/wayne/FPGA_stuff/FinancialAccleration/TestEnvironments/ip_example_dir/themashallah_ex/themashallah_ex.runs/themashallah_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log themashallah.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source themashallah.tcl
