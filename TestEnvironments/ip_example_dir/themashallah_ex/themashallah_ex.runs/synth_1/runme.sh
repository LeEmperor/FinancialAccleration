...
HD_PWD='/home/wayne/FPGA_stuff/FinancialAccleration/TestEnvironments/ip_example_dir/themashallah_ex/themashallah_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log themashallah_exdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source themashallah_exdes.tcl
